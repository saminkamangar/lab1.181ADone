...
module mysystem_mm_interconnect_1 (
	...
	wire  [115:0] pushbuttons_s1_agent_rp_data;                                         // pushbuttons_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] hex5_hex4_s1_agent_rp_data;                                           // HEX5_HEX4_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] cmd_mux_004_src_data;                                                 // cmd_mux_004:src_data -> pushbuttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                // pushbuttons_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                              // cmd_mux_004:src_channel -> pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                                 // cmd_mux_005:src_data -> HEX5_HEX4_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                // HEX5_HEX4_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                              // cmd_mux_005:src_channel -> HEX5_HEX4_s1_burst_adapter:sink0_channel
